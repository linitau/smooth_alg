...
// a non-numpy alternative for `detail::get_2darray()`.
    ...
    bool arrow(Numeric x, Numeric y, Numeric end_x, Numeric end_y, const std::string& fc = "r",
               const std::string ec = "k", Numeric head_length = 0.25, Numeric head_width = 0.1625, double width = 1, long length_includes_head = 1) {
        ...
        PyDict_SetItemString(kwargs, "length_includes_head", PyBool_FromLong(length_includes_head));
